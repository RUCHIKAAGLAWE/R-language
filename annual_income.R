...
data_adult<-read.csv("C:/Users/Dell/Downloads/R programming data/datasets/annual_income.csv")
...
#we observed that still 3 coloum i.e."workclass", "race", "gender"
#are catagorical in nature convert them into factor
...
logit <- glm(income~age+workclass+education+educational.num+
               marital.status+ gender+hours.per.week, data = trainData, family = 'binomial')
summary(logit)
