#Regression
df <- read.csv("C:/Users/Dell/Downloads/R programming data/analytics edge R/stud_reg.csv", header = T)
View(df)
df
...
#Value of Adjusted R2 = 0.83, 
#means that "82% of the variance in the measure of mpg can be predicted by wt, qsec and am."
