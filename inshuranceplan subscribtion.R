...
Plan_Dataset <- read.csv("C:/Users/Dell/Downloads/R programming data/datasets/InsurancePlanSubscriptions-2017.csv")
View(Plan_Dataset)
...
reg_ins_formula <- lm(Annual_EE_Contri ~ #State3+
                        #State2+
                        #State1+#Marital_status1+
                        Age_Grp1+Age_Grp2+#Gender1+# Annual_Salary_Bucket1+
                        #Annual_Salary_Bucket2+
                        #Annual_Salary_Bucket3+
                        #Exp_Within_Org1+#Exp_Within_Org2+
                Employee_Class1+Coverage.Level1+Coverage.Level2,data=insurance_premium1)
...
getwd()
setwd("C:/Users/Dell/Downloads/R programming data/analytics edge R")
sm2 <- read.csv("C:/Users/Dell/Downloads/R programming data/datasets/InsurancePlanSubscriptions-2018.csv")
View(sm2)
